...
export const users = mysqlTable("users", {
  ...
  role: mysqlEnum("role", ["user", "admin", "researcher", "commander"]).default("user").notNull(),
  resonanceSignature: varchar("resonanceSignature", { length: 64 }), // 1.67x verification constant
  isResearcher: int("isResearcher").default(0).notNull(), // Primary Researcher flag
